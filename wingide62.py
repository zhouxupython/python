...
LicenseID='CN123-24567-34567-67891'  
RequestCode='RL624-DXTDL-LVYQB-K4AB4'  
import hashlib  
...
while len(D) < 17:  
    D = '1' + D  
print("The Activation Code is: "+A('AXX'+D))  # The Activation Code is: AXX32-XR434-C7H9X-FGDQ7
